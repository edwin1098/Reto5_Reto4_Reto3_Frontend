function autoInicioRelacionCliente(){
    ...
    $.ajax({
        url:"http://129.151.118.251:808080/api/Client/all",
        type:"GET",
        datatype:"JSON",
...
function autoInicioGame(){
    ...
    $.ajax({
        url:"http://129.151.118.251:808080/api/Game/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function agregarReservation() {
    ...
    if($("#startDate").val().length == 0 || $("#devolutionDate").val().length == 0 || $("#status").val().length == 0){
        ...
        $.ajax({
            ...
            url:"http://129.151.118.251:808080/api/Reservation/save",
            //url: "http://129.151.118.251:808080/api/Reservation/save",
            data: dataToSend,
            datatype: "json",
...
function listarReservation(){
    $.ajax({
        url:"http://129.151.118.251:808080/api/Reservation/all",
        //url: "http://129.151.118.251:808080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
        success: function (response) {
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.118.251:808080/api/Reservation/"+idElemento,
            //url: "http://129.151.118.251:808080/api/Reservation/" + idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
...
function cargarDatosReservation(id) {
    $.ajax({
        dataType: 'json',
        url:"http://129.151.118.251:808080/api/Reservation/"+id,
        //url: "http://129.151.118.251:808080/api/Reservation/" + id,
        type: 'GET',
...
function actualizarReservation(idElemento) {
    ...
    if($("#startDate").val().length == 0 || $("#devolutionDate").val().length == 0 || $("#status").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.118.251:808080/api/Reservation/update",
            //url: "http://129.151.118.251:808080/api/Reservation/update",
            type: "PUT",
