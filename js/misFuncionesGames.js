...
function cargarDatosGame(id) {
    $.ajax({
        dataType: 'json',
        url:"http://129.151.118.251:8080/api/Game/"+id,
        //url: "http://129.151.118.251:8080/api/Game/" + id,
        type: 'GET',
    ...
    if($("#name2").val().length == 0 || $("#developer").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://129.151.118.251:8080/api/Game/save",
                //url: "http://129.151.118.251:8080/api/Game/save",
                data: dataToSend,
                datatype: 'json',
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.118.251:8080/api/Game/"+idElemento,
            //url: "http://129.151.118.251:8080/api/Game/" + idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#developer").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.118.251:8080/api/Game/update",
            //url: "http://129.151.118.251:8080/api/Game/update",
            type: "PUT",
