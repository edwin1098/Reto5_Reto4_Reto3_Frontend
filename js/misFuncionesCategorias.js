function traerInformacionCategorias(){
    console.log("test");
        $.ajax({
        url:"http://129.151.118.251:808080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    ...
    let var2 = {
        ...
        url:"http://129.151.118.251:808080/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://129.151.118.251:808080/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        url:"http://129.151.118.251:808080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
